...
class Game(Frame):
    ...
    def createRooms(self):
        #r1 through r4 are the rooms of the mansion
        #currentRoom is the room the player currently is in
        
        #creates the rooms and give them meaningful names and an image
